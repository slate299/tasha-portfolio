        ...
        >
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            >
              ...
              <span className="bg-gradient-to-r from-accent to-accent-dark bg-clip-text text-transparent block sm:inline">
                {heroData.headline.gradient}
              </span>
            </motion.h2>
